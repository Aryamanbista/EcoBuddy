  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col hover:shadow-xl transition-shadow duration-300">
      <div className="flex items-center mb-4">
        {icon && <div className="text-green-500 text-2xl mr-4">{icon}</div>}
      ...
      {linkTo && (
        <Link 
          to={linkTo} 
          className="mt-4 text-green-600 font-semibold hover:text-green-800 self-start transition-colors duration-300"
        >
          {linkText} →
        </Link>
      )}
